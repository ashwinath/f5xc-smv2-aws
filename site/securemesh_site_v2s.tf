  ...
  data = jsonencode({
    ...
    "spec" : {
      ...
      "software_settings" : {
        "sw" : {
          "default_sw_version" : {}
          #"volterra_software_version" : "crt-20250424-5304"
        },
        "os" : {
          "default_os_version" : {}
        }
      ...
      "re_select" : {
        "geo_proximity" : {}
        #"specific_re" : {
        # staging geo proximity is pa4,sv10
        #"primary_re" : "ny8-nyc",

        # demo1
        #"primary_re" : "ves-io-newyork", #demo1 this worked
        #"primary_re" : "ves-io-paris", # need to test this if it selects pa4
        #}
      },
      #"disable_ha": {}
